...
public class UserRepositoryTest {
	...
	public void testFindByEmail() {
		...
		UserEntity returnedUser = userRepository.findByEmail("fakeUser@gmail.com");


		assertEquals("fakeUser@gmail.com", returnedUser.getEmail());
	}
	...
	public void testUpdateUser() {
		...
		assertEquals("Ivan", returnedUser.getFirstName());
		assertEquals("Petrov", returnedUser.getLastName());
	}
